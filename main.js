...
function init() {
  ...
  const materialNormalMap = new THREE.MeshPhongMaterial({
    ...
    map: textureLoader.load(
      "./three.js-master/examples/textures/planets/earth_atmos_2048.jpg"
    ),

    specularMap: textureLoader.load(
      "./three.js-master/examples/textures/planets/earth_specular_2048.jpg"
    ),
    normalMap: textureLoader.load(
      "./three.js-master/examples/textures/planets/earth_normal_2048.jpg"
    ),
  ...
  const materialClouds = new THREE.MeshLambertMaterial({
    map: textureLoader.load(
      "./three.js-master/examples/textures/planets/earth_clouds_1024.png"
    ),
    transparent: true,
  });
  ...
  const materialMoon = new THREE.MeshPhongMaterial({
    map: textureLoader.load(
      "./three.js-master/examples/textures/planets/moon_1024.jpg"
    ),
  });
